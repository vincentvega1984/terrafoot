...
<?php if ($this->msg) {
    ?>
<div class="message"><?php echo $this->msg;
    ?></div>
<?php 
}?>
<div align="right">
...
<?php
		...
		<table class="jsnoborders">
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_('BLFA_FIRSTNAME'); ?>::<?php echo JText::_('BLFA_TT_FIRST_NAME');?>"><img src="administrator/components/com_bearleague/img/quest.png" border="0" /></span>
				</td>
				<td>
					<input type="text" maxlength="255" name="first_name" value="<?php echo $row->first_name?>" />
				</td>
			</tr>
			<tr>
				<td width="100">
					<?php echo JText::_('BLFA_LASTNAME'); ?>
					<span class="editlinktip hasTip" title="<?php echo JText::_('BLFA_LASTNAME'); ?>::<?php echo JText::_('BLFA_TT_LAST_NAME');?>"><img src="administrator/components/com_bearleague/img/quest.png" border="0" /></span>
				</td>
				<td>
					<input type="text" maxlength="255" name="last_name" value="<?php echo $row->last_name?>" />
				</td>
			</tr>
			<?php
			...
			<tr>
				...
				<td>
					<input type="text" maxlength="255" name="extraf[<?php echo $lists['ext_fields'][$p]->id?>]" value="<?php echo isset($lists['ext_fields'][$p]->fvalue) ? htmlspecialchars($lists['ext_fields'][$p]->fvalue) : ''?>" />
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_('BLFA_TEAM'); ?>::<?php echo JText::_('BLFA_TEAM');?>"><img src="administrator/components/com_bearleague/img/quest.png" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_('BLFA_ABOUT_PLAYER'); ?>::<?php echo JText::_('BLFA_TT_ABOUT_PLAYER');?>"><img src="administrator/components/com_bearleague/img/quest.png" border="0" /></span>
				</td>
				<td>
		...
		<table style="padding:10px;" class="jsnoborders">
			<tr>
				<td>
					<?php echo JText::_('BLFA_UPLOADPHOT');?>
				</td>
			</tr>
			<tr>
				<td>&nbsp;
		...
		<table class="adminlist">
            ...
            foreach ($lists['photos'] as $photos) {
                ?>
			<td align="center">
				<a href="javascript:void(0);" title="<?php echo JText::_('BLFA_REMOVE')?>" onClick="javascript:Delete_tbl_row(this);"><img src="<?php echo JURI::base();
                ?>components/com_joomsport/img/ico/close.png" title="<?php echo JText::_('BLFA_REMOVE')?>" /></a>
			</td>
			<td align="center">
				<?php
			...
			<td align="center">
                ...
                ?>
				<a rel="{handler: 'image'}" href="<?php echo JURI::base();
                ?>media/esport/<?php echo $photos->filename?>" title="Image" class="modal-button"><img src="<?php echo JURI::base();
