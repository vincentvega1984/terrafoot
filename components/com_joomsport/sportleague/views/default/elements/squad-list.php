                ...
                ?>
                    ...
                    <div class="jstable-cell">
                        ...
                        if ($rows->lists['squard1'][$intP]->player_out) {
                            if($rows->lists['squard1'][$intP]->player_in){
                                echo '<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-new.png" class="sub-player-ico" title="" alt="" />';
                            }else{
                              echo '<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-raw.png" class="sub-player-ico" title="" alt="" />';
                ...
                ?>
                    ...
                    <div class="jstable-cell">
                        ...
                        if ($rows->lists['squard2'][$intP]->player_out) {
                            if($rows->lists['squard2'][$intP]->player_in){
                                echo '<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-new.png" class="sub-player-ico" title="" alt="" />';
                            }else{
                              echo '<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-raw.png" class="sub-player-ico" title="" alt="" />';
            ...
            for ($intP = 0; $intP < count($rows->lists['squard1_res']); ++$intP) {
                ...
                ?>
                    ...
                    <div class="jstable-cell">
                        ...
                        if($rows->lists['squard1_res'][$intP]->sb2m){
                            if($rows->lists['squard1_res'][$intP]->sb2in){
                                echo '&nbsp;<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-new.png" class="sub-player-ico" title="" alt="" />';
                            }else{
                              echo '&nbsp;<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-raw.png" class="sub-player-ico" title="" alt="" />';

                            }
                            echo '&nbsp;'.$rows->lists['squard1_res'][$intP]->sb2m."'";
                        }
                ?>
                    </div>
                </div>    
            ...
            for ($intP = 0; $intP < count($rows->lists['squard2_res']); ++$intP) {
                ...
                ?>
                    ...
                    <div class="jstable-cell">
                        ...
                        if($rows->lists['squard2_res'][$intP]->sb2m){
                            if($rows->lists['squard2_res'][$intP]->sb2in){
                                echo '&nbsp;<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-new.png" class="sub-player-ico" title="" alt="" />';
                            }else{
                              echo '&nbsp;<img src="'.JS_LIVE_URL.'components/com_joomsport/img/ico/out-raw.png" class="sub-player-ico" title="" alt="" />';

                            }
                            echo '&nbsp;'.$rows->lists['squard2_res'][$intP]->sb2m."'";
                        }
                ?>
                    </div>
                </div>    
