...
<div id="k2Container" class="productView">
	...
	<div class="productBody">
		...
		<div class="productInfo">
			...
			<!-- Item Image -->
			<div class="productImageBlock desktop">
			...
			<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
			<!-- Item Image -->
			<div class="productImageBlock mobile">
				<a data-k2-modal="image" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
					<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" />
				</a>
			...
			<div class="get-quote-wrapper">
				<a href="tel:+380676609626" class="get-quote">
					Заказать
				</a>
			</div>
			...
			<div class="productExtraFields">
				...
				<div class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?> alias<?php echo ucfirst($extraField->alias); ?>">
					<?php if($extraField->type == 'header'): ?>
					<h4 class="productExtraFieldsHeader"><?php echo $extraField->name; ?></h4>
					<?php else: ?>
					<span class="productExtraFieldsLabel"><?php echo $extraField->name; ?>:</span>
					<span class="productExtraFieldsValue"><?php echo $extraField->value; ?></span>
					<?php endif; ?>
				</div>
				<?php endif; ?>
				<?php endforeach; ?>
