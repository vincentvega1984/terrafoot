...
<div id="k2Container" class="itemListView">
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer">
				<div class="subCategory">
					...
					<!-- Subcategory title -->
					<a href="<?php echo $subCategory->link; ?>" class="subCatTitle">
						<h4><?php echo $subCategory->name; ?><?php if($this->params->get('subCatTitleItemCounter')) echo ' ('.$subCategory->numOfItems.')'; ?></h4>
					</a>
					<?php endif; ?>
	...
	<div class="changeView">
		<span class="list">Список</span>
		<span class="grid active">Плитка</span>
	</div>
