...
<!-- Sticky sidebar + add class if have navigation -->
<script>
jQuery.noConflict();
	(function( $ ) {
		$(document).ready(function(){

			if ($("#k2Container.itemView aside").length > 0){
				$("#k2Container.itemView").addClass("has-sidebar");
			}

			$(window).scroll(function() {
			  if ($(this).scrollTop() >= 270) {
			      var $aside = $('aside');
			      var rightOffset = ($(window).width() - ($aside.offset().left + $aside.outerWidth()));
			      $('aside').addClass("sticky");
			      $('aside').css('right', rightOffset);
			  } else {
